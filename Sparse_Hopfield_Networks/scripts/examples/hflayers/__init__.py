...
class Hopfield(Module):
    ...
    def __init__(self,
                 ...
                 alpha: Optional[Union[float, Tensor]] = 1.0,
                 normmax: bool = False,
                 sparseMAP: bool = False,
                 k: int = 2,
                 num_heads: int = 1,
        ...
        self.association_core = HopfieldCore(ypsi=ypsi,
            embed_dim=input_size, alpha=alpha, normmax=normmax, sparsemap = sparseMAP, k = k, num_heads=num_heads, dropout=dropout, bias=input_bias,
            ...
            disable_out_projection=disable_out_projection, alpha_as_static=alpha_as_static, key_as_static=stored_pattern_as_static,
    ...
    def get_parameter_value(self):
        return self.association_core.get_parameter_value()
...
class HopfieldPooling(Module):
    ...
    def __init__(self,
                 ...
                 normalize_stored_pattern: bool = False,
                 normalize_stored_pattern_affine: bool = False,
                 normalize_state_pattern: bool = False,
                 normalize_state_pattern_affine: bool = False,
                 normalize_pattern_projection: bool = False,
                 normalize_pattern_projection_affine: bool = False,
                 normalize_hopfield_space: bool = False,
                 normalize_hopfield_space_affine: bool = False,
                 alpha_as_static: bool = True,
                 stored_pattern_as_static: bool = False,
        ...
        self.hopfield = Hopfield(ypsi=ypsi,
            input_size=input_size, hidden_size=hidden_size, output_size=output_size, pattern_size=pattern_size,
            num_heads=num_heads, alpha = alpha, normmax=normmax, sparseMAP=sparseMAP, k=k, scaling=scaling, update_steps_max=update_steps_max, update_steps_eps=update_steps_eps,
            ...
            normalize_hopfield_space_affine=normalize_hopfield_space_affine, alpha_as_static=alpha_as_static,
    ...
    def get_projected_pattern_matrix(self, input: Union[Tensor, Tuple[Tensor, Tensor]],
        ...
        with torch.no_grad():
            return self.hopfield.get_projected_pattern_matrix(
                ...
                association_mask=association_mask)
    def get_parameter_value(self):
        return self.hopfield.get_parameter_value()
    @property
    def batch_first(self) -> bool:
